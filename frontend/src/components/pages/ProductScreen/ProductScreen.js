...
const ProductScreen = ({ match }) => {
  ...
  useEffect(() => {
    if (cart.productInCart.some((item) => item.product === product._id)) {
      setIsInCart(true);
    } else {
      setIsInCart(false);
    }
            ...
            <div className="ProductScreen-box">
              ...
              <div className="ProductScreen-box-info">
                  ...
                  {outOfStock(!product.countInStock) ? (
                    <div className="ProductScreen-box-info-add-in-stock">
                      <p>
                        ...
                        <br />
                        Зв'яжіться з нами і ми обов'язково повідомимо вам про
                        його наявність !
                      </p>
                    </div>
                  ) : (
                ...
                <div className="ProductScreen-box-info-footer">
                  ...
                  <p>
                    Щасливу людину дуже просто впізнати. Вона ніби випромінює
                    ауру спокою і тепла. Секрет щасливих людей простий - це
                    відсутність напруги. Це задоволення собою. Огортаючи ніжки
                    пухнастими шкарпеточками, ви отримуєте тепло. Додайте каву
                    та шоколад. Разом - це спокій та щастя !
                  </p>
                </div>
              </div>
            </div>
